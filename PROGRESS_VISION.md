...
- **Transitions (In Progress 🚧):** Algorithmic, macro-level controls to program transitions and alter inner voices (e.g., injecting passing tones, suspensions, or generative behavioral personas). Phase 1 (Core UI, Math Engine, and Audio/MIDI Export) is complete. Generative anchoring and cross-layer physics are planned next. Operates as a dedicated mode within the Chords Pattern Tab.
