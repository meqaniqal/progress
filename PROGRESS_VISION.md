...
- **Smart Voice Tweaking (In Progress 🚧):** Algorithmic, macro-level controls to alter inner voices (e.g., injecting passing tones, suspensions, or generative behavioral personas). Operates as a dedicated mode within the Chords Pattern Tab. See `smart_voice_tweaking_plan.md` for detailed architecture.
