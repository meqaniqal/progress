export const CONFIG = {
    ...
    UI_STATE_SYNC_TIMEOUT_MS: 50,
    VL_CENTER_GRAVITY: 54,
    VL_GRAVITY_WEIGHT: 0.5,
    VL_EXTREME_HIGH: 84,
    VL_EXTREME_LOW: 36,
    VL_EXTREME_WEIGHT: 5,
    VL_ROOT_PENALTY: 15,
    VL_CROSS_TETHER_WEIGHT: 10,
    VL_OCTAVE_SHIFT: 12.0,
    VL_GATE_DURATION_SEC: 0.8
};