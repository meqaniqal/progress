    ...
    lofi: {
        ...
        drumPattern: {
            ...
            hits: [
                ...
                { time: 0.15625, row: 'kick', velocity: 0.7, probability: 0.8 },
                { time: 0.25, row: 'snare', velocity: 0.85, probability: 1.0 },
                { time: 0.46875, row: 'kick', velocity: 0.8, probability: 0.9 },
                { time: 0.75, row: 'snare', velocity: 0.85, probability: 1.0 },
                // Slack hats
                { time: 0.0, row: 'ch', velocity: 0.5, probability: 0.9 },
                { time: 0.0625, row: 'ch', velocity: 0.35, probability: 0.85 },
                { time: 0.125, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.1875, row: 'ch', velocity: 0.35, probability: 0.85 },
                { time: 0.25, row: 'ch', velocity: 0.5, probability: 0.9 },
                { time: 0.3125, row: 'ch', velocity: 0.35, probability: 0.85 },
                { time: 0.375, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.4375, row: 'ch', velocity: 0.35, probability: 0.85 },
                { time: 0.5, row: 'ch', velocity: 0.5, probability: 0.9 },
                { time: 0.5625, row: 'ch', velocity: 0.35, probability: 0.85 },
                { time: 0.625, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.6875, row: 'ch', velocity: 0.35, probability: 0.85 },
                { time: 0.75, row: 'ch', velocity: 0.5, probability: 0.9 },
                { time: 0.8125, row: 'ch', velocity: 0.35, probability: 0.85 },
                { time: 0.875, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.9375, row: 'ch', velocity: 0.35, probability: 0.85 }
            ]
        }
    },
    neosoul: {
        ...
        drumPattern: {
            ...
            hits: [
                { time: 0.0, row: 'kick', velocity: 0.9, probability: 1.0 },
                { time: 0.1875, row: 'kick', velocity: 0.7, probability: 0.85 },
                { time: 0.25, row: 'snare', velocity: 0.8, probability: 1.0 },
                { time: 0.375, row: 'kick', velocity: 0.85, probability: 0.9 },
                { time: 0.5625, row: 'kick', velocity: 0.7, probability: 0.8 },
                { time: 0.75, row: 'snare', velocity: 0.8, probability: 1.0 },
                { time: 0.9375, row: 'kick', velocity: 0.65, probability: 0.7 },
                // Soulful hats
                { time: 0.0, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.0625, row: 'oh', velocity: 0.5, probability: 0.8 },
                { time: 0.125, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.1875, row: 'ch', velocity: 0.45, probability: 0.8 },
                { time: 0.25, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.3125, row: 'ch', velocity: 0.45, probability: 0.8 },
                { time: 0.375, row: 'oh', velocity: 0.6, probability: 0.95 },
                { time: 0.4375, row: 'ch', velocity: 0.45, probability: 0.8 },
                { time: 0.5, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.5625, row: 'oh', velocity: 0.5, probability: 0.8 },
                { time: 0.625, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.6875, row: 'ch', velocity: 0.45, probability: 0.8 },
                { time: 0.75, row: 'ch', velocity: 0.6, probability: 0.9 },
                { time: 0.8125, row: 'ch', velocity: 0.45, probability: 0.8 },
                { time: 0.875, row: 'oh', velocity: 0.6, probability: 0.95 },
                { time: 0.9375, row: 'ch', velocity: 0.45, probability: 0.8 }
            ]
        }
    },
    synthwave: {
        ...
        drumPattern: {
            ...
            hits: [
                ...
                { time: 0.25, row: 'snare', velocity: 0.95, probability: 1.0 },
                { time: 0.5, row: 'kick', velocity: 1.0, probability: 1.0 },
                { time: 0.75, row: 'snare', velocity: 0.95, probability: 1.0 },
                // Constant 8th note hats with slight velocity accenting
                { time: 0.0, row: 'ch', velocity: 0.7, probability: 1.0 },
                { time: 0.125, row: 'ch', velocity: 0.55, probability: 1.0 },
                { time: 0.25, row: 'ch', velocity: 0.7, probability: 1.0 },
                { time: 0.375, row: 'ch', velocity: 0.55, probability: 1.0 },
                { time: 0.5, row: 'ch', velocity: 0.7, probability: 1.0 },
                { time: 0.625, row: 'ch', velocity: 0.55, probability: 1.0 },
                { time: 0.75, row: 'ch', velocity: 0.7, probability: 1.0 },
                { time: 0.875, row: 'ch', velocity: 0.55, probability: 1.0 }
            ]
        }
    },
    idm: {
        ...
        drumPattern: {
            ...
            hits: [
                { time: 0.0, row: 'kick', velocity: 0.9, probability: 1.0 },
                { time: 0.09375, row: 'kick', velocity: 0.75, probability: 0.8 },
                { time: 0.21875, row: 'clap', velocity: 0.6, probability: 0.5 },
                { time: 0.25, row: 'snare', velocity: 0.8, probability: 1.0 },
                { time: 0.375, row: 'oh', velocity: 0.7, probability: 0.9 },
                { time: 0.5625, row: 'kick', velocity: 0.85, probability: 0.9 },
                { time: 0.6875, row: 'snare', velocity: 0.5, probability: 0.4 },
                { time: 0.75, row: 'snare', velocity: 0.85, probability: 1.0 },
                { time: 0.84375, row: 'clap', velocity: 0.6, probability: 0.7 },
                { time: 0.875, row: 'ch', velocity: 0.7, probability: 0.8 },
                { time: 0.90625, row: 'ch', velocity: 0.6, probability: 0.75 },
                { time: 0.9375, row: 'oh', velocity: 0.8, probability: 0.9 }
            ]
        }
    },
    afrobeat: {
        ...
        drumPattern: {
            ...
            hits: [
                { time: 0.0, row: 'kick', velocity: 0.9, probability: 1.0 },
                { time: 0.125, row: 'clap', velocity: 0.7, probability: 0.9 },
                { time: 0.25, row: 'snare', velocity: 0.8, probability: 1.0 },
                { time: 0.375, row: 'kick', velocity: 0.85, probability: 1.0 },
                { time: 0.5625, row: 'kick', velocity: 0.8, probability: 0.9 },
                { time: 0.625, row: 'clap', velocity: 0.7, probability: 0.9 },
                { time: 0.75, row: 'snare', velocity: 0.8, probability: 1.0 },
                // Percussion layers (rim/hats/shakers)
                { time: 0.0, row: 'ch', velocity: 0.65, probability: 1.0 },
                { time: 0.0625, row: 'ch', velocity: 0.5, probability: 0.95 },
                { time: 0.125, row: 'oh', velocity: 0.7, probability: 1.0 },
                { time: 0.1875, row: 'ch', velocity: 0.5, probability: 0.95 },
                { time: 0.25, row: 'ch', velocity: 0.65, probability: 1.0 },
                { time: 0.3125, row: 'ch', velocity: 0.5, probability: 0.95 },
                { time: 0.375, row: 'oh', velocity: 0.7, probability: 1.0 },
                { time: 0.4375, row: 'ch', velocity: 0.5, probability: 0.95 },
                { time: 0.5, row: 'ch', velocity: 0.65, probability: 1.0 },
                { time: 0.5625, row: 'ch', velocity: 0.5, probability: 0.95 },
                { time: 0.625, row: 'oh', velocity: 0.7, probability: 1.0 },
                { time: 0.6875, row: 'ch', velocity: 0.5, probability: 0.95 },
                { time: 0.75, row: 'ch', velocity: 0.65, probability: 1.0 },
                { time: 0.8125, row: 'ch', velocity: 0.5, probability: 0.95 },
                { time: 0.875, row: 'oh', velocity: 0.7, probability: 1.0 },
                { time: 0.9375, row: 'ch', velocity: 0.5, probability: 0.95 }
            ]
        }
    },
    eastern: {
        ...
        drumPattern: {
            ...
            hits: [
                ...
                { time: 0.222, row: 'snare', velocity: 0.8, probability: 1.0 },
                { time: 0.44425, row: 'kick', velocity: 0.85, probability: 1.0 },
                { time: 0.6665, row: 'snare', velocity: 0.9, probability: 1.0 },
                { time: 0.83325, row: 'snare', velocity: 0.7, probability: 0.85 },
                // Hand drums/darbuka style shaker hits
                { time: 0.0, row: 'ch', velocity: 0.6, probability: 0.95 },
                { time: 0.111, row: 'ch', velocity: 0.5, probability: 0.9 },
                { time: 0.222, row: 'ch', velocity: 0.6, probability: 0.95 },
                { time: 0.33325, row: 'ch', velocity: 0.5, probability: 0.9 },
                { time: 0.44425, row: 'ch', velocity: 0.6, probability: 0.95 },
                { time: 0.5555, row: 'ch', velocity: 0.5, probability: 0.9 },
                { time: 0.6665, row: 'oh', velocity: 0.7, probability: 0.95 },
                { time: 0.75, row: 'ch', velocity: 0.55, probability: 0.9 },
                { time: 0.83325, row: 'oh', velocity: 0.7, probability: 0.95 },
                { time: 0.9165, row: 'ch', velocity: 0.5, probability: 0.85 }
            ]
        }
    }
};
