...
export function applyGenreRules(pitch, genre, step, scalePitches, divisions, chromaticProb = 0.0) {
    if (genre === 'jazz') {
...
export function applyOrnaments(pitch, stepTime, noteDuration, genre, intensity, inst, bus, playToneFn) {
...
export function applyMotivicFlexing(scheduled, globalScalePcSet, chordTonePcSet, periodSize, divisions) {
