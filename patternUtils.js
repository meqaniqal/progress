...
import { drawPatternBlock as _drawPatternBlock } from './patternDrawMath.js';
...
export function moveInstance(pattern, instanceId, newStartTime, intendedDuration = null) {
    ...
    const MIN_DURATION = CONFIG.MIN_SLICE_DURATION;
...
export function drawPatternBlock(pattern, startTime, duration, isEraser = false) {
    return _drawPatternBlock(pattern, startTime, duration, isEraser, generateId);
}